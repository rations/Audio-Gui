...
static void peak_open(uint32_t rate) {
...
static int jack_process(jack_nframes_t nframes, void *arg) {
    ...
    /* Soft clip, tracking the block peak for the meter */
...
int main(int argc, char *argv[]) {
    ...
    j_client = jack_client_open("pulse_bridge", JackNoStartServer, &jstatus);
    if (!j_client) {
        fprintf(stderr,
    ...
    fprintf(stderr,
        ...
        "pulse-jack-bridge: JACK %u Hz, %u-frame period, client 'pulse_bridge'\n"
